 ...
 *
 */
@WebServlet("/Emp_allEmpServlet")
public class Emp_allEmpServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String eis = req.getParameter("eis");
		...
		String sql = "SELECT\r\n" + 
				...
				"        ON (`t_emp`.`p_id` = `t_part`.`p_id`) where e_is = ?;";
		ResultSet rs = DBHelper.executeQuery(conn, sql,eis);
		try {
			while(rs.next()) {
