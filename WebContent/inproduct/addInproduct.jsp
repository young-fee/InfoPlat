		...
		<div class="formbody" style="width: 450px;">
			<ul class="forminfo1">
				<li>
					...
					<SPAN class="inprospan"> ${tProduct.PName}</SPAN>
					<input type="hidden" value="${tProduct.PId}" id="PName">
				</li>
				<li>
					<label>
						　产品产地：
					</label>
					<SPAN  class="inprospan" id="PArea"> ${tProduct.PArea}</SPAN>
				</li>
				<li>
					<label>
						入库申请人：
				...
				<li>
					...
					<SPAN  class="inprospan" id="ETruename"> ${loginUser.ETruename}</SPAN>
				</li>
