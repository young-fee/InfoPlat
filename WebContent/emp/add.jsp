...
<html>
	...
	<body>
		<div class="formbody">
			...
			<ul class="forminfo1">
				<li><label>真实姓名：</label>
					<input name="emp.ETruename" class="dfinput1" id="ETruename" />
				</li>
				<li>
					<label>登录名称：</label>
					<input name="emp.ELoginname" class="dfinput1" id="ELoginname" />
				</li>
				<li>
					<label>登录密码：</label>
					<input type="password" class="dfinput1" id="EPsw">
				</li>
				<li>
					<label>所在部门：</label>
					<div class="vocation">
						<select name="emp.TPart.PId" class="selectinput" id="PId">
						<c:forEach var="part" items="${tpartList}">
				...
				<li>
					<label>员工备注：</label>
					<textarea rows="" cols="" class="textinput2" name="emp.ERemark" id="ERemark"></textarea>
				</li>
				<li>
					<label>员工类别：</label>
					<div class="vocation">
