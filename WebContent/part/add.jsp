	...
	<body>
		<div class="formbody">
			<ul class="forminfo1">
				<li>
					<label>部门名称：</label>
					<input name="tPart.PName" type="text" id="PName" class="dfinput1 newdefault" placeholder="请输入部门名称" />
				</li>
				<li>
					<label>部门备注：</label>
					<textarea name="tPart.PRemark" cols="" rows="" class="textinput2" id="PRemark" placeholder="请输入部门备注"></textarea>
				</li>
				<li>
					<label>&nbsp;</label>
