...
<html>
	...
	<body
		style="background-color: #1c77ac; background-image: url(${pageContext.request.contextPath}/images/light1.png); background-repeat: no-repeat; background-position: center top; overflow: hidden;">
		...
		<div class="loginbody">
			...
			<div class="loginbox">
				<ul>
					<li>
						<input name="emp.ELoginname" type="text" class="loginuser"
							placeholder="请输入用户名" id="loginuser" />
					</li>
					<li>
						<input name="emp.EPsw" type="password" class="loginpwd" id="upsw"
							placeholder="请输入密码" />
					</li>
					<li>
