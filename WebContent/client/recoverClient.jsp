		...
		<div class="formbody" style="width: 450px;">
			<ul class="forminfo1">
				...
				<input type="hidden"  id="cid" value="${cid}">
					...
					<input type="hidden" class="dfinput1 newdefault" id="cname" value="${client.CName}"
						placeholder="请输入客户姓名">
				</li>
				<li>
					<input type="hidden" class="dfinput1 newdefault" id="ctel" value="${client.CTel}"
						placeholder="请输入客户联系方式">

				</li>
				<li>
					<input type="hidden" class="dfinput1 newdefault" id="caddress" value="${client.CAddress}"
						placeholder="请输入客户地址">
